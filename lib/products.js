...
const PRODUCTS = [
    ...
    },
    {
        ...
        ready: 'return document.readyState === "complete" && !!document.querySelector("#canvas")',
        capabilities: { webgl: true, audio: false, camera: false, midi: false, drag: false },
        notes: 'Runs real server for real CSP. FORCES landscape. Loads shader bundles from external hosts (needs network). #toggle-dsl-overlay, #menuLeft, [data-param].',
    },
...
module.exports = { PRODUCTS, BY_KEY, PLATFORM_ROOT, allKeys, resolve }
